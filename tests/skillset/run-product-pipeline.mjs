 ...
 */
const BASELINES = {
	// 白 50/52（取りこぼし: 存在感・末脚）・確認行き 2（「守在盛」「本瞞」）・画面に無いもの 0。
	// 30セッション目に 49 → 50: 「連綿」を psm 13 の読み直し（skillset-ocr.js）＋ 遣→途 の読み替え（common.js）で拾えるようになった。
	// それまでは Step 0 報告の T2-5（集合の指標）と同じ 49/52。
	'2026-09-11a': { coverage: [50, 52], review: 2 },
